...
Public Class Libro_Balance_Saldos
    ...
    Private Sub cargargridview()
        ...
        lista = obj.Mostrarlibrobalancesaldos(TextBox1.Text, TextBox2.Text, TextBox3.Text, TextBox4.Text)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If path1.SelectedPath.ToString.Length > 0 Then
            path = path1.SelectedPath.ToString + "\libro_balance_saldos.XML"
