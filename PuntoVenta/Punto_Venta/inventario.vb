...
Public Class Inventario
    ...
    Private Sub cargargridview()
        ...
        Dim obj As New Negocio_Inventario
        lista = obj.MostrarInventario(TextBox1.Text, TextBox2.Text, TextBox3.Text, TextBox4.Text)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If path1.SelectedPath.ToString.Length > 0 Then
            Dim path As String
            path = path1.SelectedPath.ToString + "\inventario.XML"
