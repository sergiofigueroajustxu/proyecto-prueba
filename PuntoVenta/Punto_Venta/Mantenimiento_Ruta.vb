...
Imports System.IO
Public Class Mantenimiento_Ruta
    ...
    Private Sub modificar_ruta()
        Dim Entidad As New Entidad_Ruta
        Dim Negocio As New Negocio_Ruta
        With Entidad
        ...
        Negocio.Modificar_ruta(Entidad)
    End Sub
    'Nueva Categoria'
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        Dim lista As New List(Of Entidad_Ruta)
        Dim obj As New Negocio_Ruta
        lista = obj.Mostrarruta(Me.TextBox1.Text)
        DataGridView1.DataSource = lista
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If path1.SelectedPath.ToString.Length > 0 Then
            path = path1.SelectedPath.ToString + "\ruta.XML"
            ...
            lista = obj.Mostrarruta(TextBox1.Text)
            'DataGridView1.DataSource = lista
