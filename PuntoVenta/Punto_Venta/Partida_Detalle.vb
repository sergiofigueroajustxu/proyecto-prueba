...
Public Class Partida_Detalle
    Private Sub Partida_Detalle_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargarcombosucursal()
    End Sub
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        ...
        End With
        Partida.totDebe.Value = Partida.totDebe.Value + debe.Value
        Partida.totHaber.Value = Partida.totHaber.Value + haber.Value
