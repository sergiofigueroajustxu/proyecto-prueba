...
Public Class Partida
    ...
    Private Sub Partida_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With ListView1
            .View = View.Details
            .Columns.Add("Id", 100)
            .Columns.Add("Cuenta", 200)
            .Columns.Add("C.C.", 50, HorizontalAlignment.Right)
            .Columns.Add("Debe", 100, HorizontalAlignment.Right)
            .Columns.Add("Haber", 100, HorizontalAlignment.Right)
        End With
    ...
    Private Sub All_filter_click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        traslada_datos_captura_detalle_partida(etiqueta.Text)


    End Sub

    Sub traslada_datos_captura_detalle_partida(ByVal idcuenta As String)
        ...
        If listaCuentas.Count > 0 Then
            Partida_Detalle.cuenta.Text = listaCuentas.Item(0).cuenta
            Partida_Detalle.Nombre_Cuenta.Text = listaCuentas.Item(0).nombre
            Partida_Detalle.Show()
        End If
    End Sub
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListView1.Click
        If ListView1.SelectedItems.Count > 0 Then
            ...
            If respuesta = MsgBoxResult.Yes Then
                ...
                traslada_datos_captura_detalle_partida(idcuenta)
            End If
