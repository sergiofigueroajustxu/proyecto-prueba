...
Public Class PagosFacturas
    ...
    Private Sub PagosFacturas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub cargargridview(ByVal id As Integer)
        ...
        Dim lista2 As New List(Of Entidad_Compras)
        Dim obj2 As New Negocio_Compras
